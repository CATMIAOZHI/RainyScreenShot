package com.rainy.screenshot.ui.theme

import androidx.compose.ui.graphics.Color

/**
 * 雨晴风格配色（RainyStyle Palette）—— 对齐 RainyToken。
 *
...
val StatusOrange = Color(0xFFFFA726)      // 注意
val StatusRed = Color(0xFFE91E63)         // 错误 / 异常
val StatusBlue = Color(0xFF64B5F6)        // 信息
...
val DarkInkWarm = Color(0xFFEFE0E5)
val DarkInkMuted = Color(0xFFC9B8BE)
val DarkInkOutline = Color(0xFF4D3A42)